...
$result = mysqli_query($con,$sql);
	...
	while ($row = mysqli_fetch_array($result)) 
	{
		# code...
					...
					$sql22 = "SELECT * FROM interneligibility WHERE ID = '".$row['ID']."'" ;
					...
					if ($row22['Year1'] && $year == 1) {
						# code...
						$show = 1; 
					}
					if ($row22['Year2'] && $year == 2) {
						# code...
						$show = 1; 
					}
					if ($row22['Year3'] && $year == 3) {
						# code...
						$show = 1; 
					}
					if ($row22['Year4'] && $year == 4) {
						# code...
						$show = 1; 
					}
					...
					$days = $diff->format('%R%a'); 
						...
						if ($brancheligibility == 1 && $minimummark == 1 && $days <= 15 && $days >= 0 && $dobDays >=0 && $show) {
