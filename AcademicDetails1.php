 ...
 <body style="background-image: url(images/criscros.jpg) ; 
 	...
 	<div class= "nav-bar" style="background-image: url(images/newspaper.jpg); 
		...
		<div style="background-image: url(images/newspaper.jpg); background-size: cover; margin-top: 0;">
		 <button align="center" style=" background-color:#366bd6;color: white;text-decoration:none;padding: 7px 20px;border: none;border-radius: 4px;cursor: pointer; margin: 10px;"><a style="color: white;text-decoration: none;"href="student.php" >Back</a>
		 </button>
...
<div class= "contain" style="background: lightcyan;border-radius: 15px;width:70%; position:relative;left:15%; opacity: 0.9">
	<div class="row">
 	 ...
 	 <p style="text-align: center;">
 	 	<button style="background-color:#366bd6;color: white;text-decoration:none;padding: 7px 20px;border: none;border-radius: 4px;cursor: pointer; margin-top: 20px;">
